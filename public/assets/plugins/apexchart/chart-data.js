...
$(document).ready(function () {
    ...
    if ($("#bar").length > 0) {
        var annee_scolaire = JSON.parse(document.getElementById("anneeScolaire").getAttribute("data-anneeScolaire"));
        var boys = JSON.parse(document.getElementById("boys").getAttribute("data-boys"));
        var girls = JSON.parse(document.getElementById("girls").getAttribute("data-girls"));
        console.log(boys);
        console.log(girls);
        console.log(annee_scolaire);
        var arr = [2023, 2024, 2025];
        var optionsBar = {
            chart: {
                type: "bar",
                height: 350,
