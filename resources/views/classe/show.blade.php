...
@section('content')
    <div class="page-wrapper">
            ...
            @if (Session::get('role_id') === 3)
                <div class="col-auto text-end ms-auto download-grp mb-2">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#nouvelleActiviteModal">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text"><i class="fas fa-sitemap"></i> Level: {{ $classe->filiere->niveau->nom }}
                            </p>
                                ...
                                @foreach ($classe->etudiants as $etudiant)
                                    <li class="list-group-item d-flex align-items-center">
                                        <img src="{{ Storage::url($etudiant->photo) }}"
                                            ...
                                            class="img-thumbnail rounded-circle me-3" style="width: 50px; height: 50px;">
                                        {{ $etudiant->nom }} {{ $etudiant->prenom }}
                                        <!-- Eye icon link -->
                                        <a href="{{ route('etudiants.show', $etudiant->id) }}"
                                            class="btn btn-sm bg-danger-light ms-auto">
                            ...
                            @if (count($classe->activites) > 0)
                                <ul class="list-group">
                                    @foreach ($classe->activites as $homework)
                                                ...
                                                @if (Session::get('role_id') === 3)
                                                    <span class="float-end me-2">
                                                        <a href="#editModal{{ $homework->id }}" data-bs-toggle="modal"
                                                            ...
                                                            <i class="far fa-edit me-2"></i> <!-- Edit Icon -->
                                                        </a>
                                                        <form action="{{ route('activite.destroy', $homework->id) }}"
                                                            method="POST" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <i class="far fa-trash-alt me-2" style="cursor: pointer;"
                                        ...
                                        <div class="modal fade" id="showInfoModal{{ $homework->id }}" tabindex="-1"
                                            aria-labelledby="showInfoModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="showInfoModalLabel">Stored Information
                                                        </h5>
                                        ...
                                        <!-- Edit Modal -->
                                        <div class="modal fade" id="editModal{{ $homework->id }}" tabindex="-1"
                                            aria-labelledby="editModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="nouvelleActiviteModalLabel">New Activity
                                                        </h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="POST"
                                                            action="{{ route('activite.update', $homework->id) }}">
                                                            @csrf
                                                            <input type="hidden" value="{{ $classe->id }}"
                                                                name="classe_id">
                                                            <!-- Activity Type -->
                                                            <div class="mb-3">
                                                                <label for="activiteType" class="form-label">Activity
                                                                    Type</label>
                                                                <select class="form-select" id="activiteType"
                                                                    name="type" required>
                                                                    <option value="exam"
                                                                        {{ $homework->type === 'exam' ? 'selected' : '' }}>
                                                                        Exam</option>
                                                                    <option value="exercice"
                                                                        {{ $homework->type === 'exercice' ? 'selected' : '' }}>
                                                                        Exercice</option>
                                                                    <option value="avis"
                                                                        {{ $homework->type === 'avis' ? 'selected' : '' }}>
                                                                        Avis</option>
                                                                    <!-- Add options here -->
                                                                </select>
                                                                @error('type')
                                                                ...
                                                                <select class="form-select" id="matiere_id"
                                                                    ...
                                                                    @foreach ($matieres as $matiere)
                                                                        <option value="{{ $matiere->id }}"
                                                                            {{ $homework->matiere_id === $matiere->id ? 'selected' : '' }}>
                                                                            {{ $matiere->nom }}</option>
                                                                    @endforeach
                                                                    <!-- Add options here -->
                                                                </select>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="title"
                                                                    name="title" value="{{ $homework->title }}"
                                                                    required>
                                                                @error('title')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                            ...
                                                            <!-- Date and Time -->
                                                            <div class="mb-3">
                                                                <label for="date" class="form-label">Date & Hour
                                                                    *</label>
                                                                <input type="datetime-local" class="form-control"
                                                                    id="date" name="date"
                                                                    value="{{ $homework->date }}" required>
                                                                `@error('date')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="ressources"
                                                                    class="form-label">Ressources</label>
                                                                <input type="text" class="form-control"
                                                                    id="ressources" name="ressources"
                                                                    value="{{ $homework->ressources }}"
                                                            ...
                                                            <!-- Remarks -->
                                                            <div class="mb-3">
                                                                <label for="desciprtion"
                                                                    class="form-label">Desciprtion</label>
                                                                <textarea class="form-control" name="description" id="desciprtion" rows="5">{{ $homework->description }}</textarea>
                                                                @error('description')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                        ...
                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="deleteModal{{ $homework->id }}" tabindex="-1"
                        ...
                        <div class="card-body">
                            <div class="page-header"> 
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp" data-bs-toggle="modal"
                                                        ...
                                                        <h2 class="table-avatar">
                                                            <a href=""class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-circle"
                                                                    src="{{ Storage::url($absence->Etudiant->photo) }}"
                                                                    alt="User Image">
                                                            </a>
                                                            <a href="">{{ $absence->Etudiant->nom }}
                                                                {{ $absence->Etudiant->prenom }}</a>
                                                        </h2>
                                                    </td>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="absenceModalLabel">Formulaire d'absence
                                                                            </h5>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form method="POST"
                                                                                action="{{ route('absences.store') }}">
                                                                                @csrf
                                                                                <div class="mb-3">
                                                                                    <label for="etudiant_id"
                                                                                        class="col-form-label">Apprenant:</label>
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="cours_id"
                                                                                        class="col-form-label">Seance:</label>
                                                                                    <select name="cours_id"
                                                                                        ...
                                                                                        @if ($classe->cours->count() > 0)
                                                                                            @foreach ($classe->cours as $cour)
                                                                                                <option
                                                                                                    value="{{ $cour->id }}">
                                                                                                    {{ $cour->matiere->nom }}{{ $cour->start_datetime }}-{{ $cour->end_datetime }}
                                                                                                </option>
                                                                                            @endforeach
                                                                                        @else
                                                                                            <option value="">There is
                                                                                                no cours for this class
                                                                                            </option>
                                                                                        @endif
                                                                                    </select>
                                                                                    @error('cours_id')
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="remarques"
                                                                                        class="col-form-label">Remarques:</label>
        ...
        <!-- Modal -->
        <div class="modal fade" id="nouvelleActiviteModal" tabindex="-1" aria-labelledby="nouvelleActiviteModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <!-- Modal absent-->
        <div class="modal fade" id="absenceModal" tabindex="-1" aria-labelledby="absenceModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('absences.store') }}">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="justification"
                                        id="justification">
