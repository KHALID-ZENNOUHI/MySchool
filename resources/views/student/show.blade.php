                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="student-profile-head" style="height: 15rem">
                                <div class="profile-bg-img" style="height: 100px; overflow: hidden;">  <!-- Added inline style -->
                                    <img src="../images/banner.jpg" alt="Profile" style="width: 100%;">
                                </div>
                                <div class="row bg-white">   
                                    <div class="col-lg-4 col-md-4">
                                        <div class="profile-user-box">
                                            <div class="profile-user-img">
                                                <img src="{{ Storage::url($etudiant->photo) }}" alt="Profile">
                                                
                                            </div>
                                            <div class="names-profiles">
                                                <h4>{{$etudiant->nom}} {{$etudiant->prenom}}</h4>
                                                <h5>{{$etudiant->classe->filiere->niveau->nom}}</h5>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Options </h4>
                                                <h5>{{$etudiant->classe->filiere->nom}}</h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
                                        ...
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Email</h4>
                                                <h5><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="81e5e0e8f2f8c1e6ece0e8edafe2eeec">{{$etudiant->email}}</a>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
